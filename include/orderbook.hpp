...
private:
	...
	// const map<double, vector<unique_ptr<Order>>, less<double>>& get_bids() { return m_bids; }
	// const map<double, vector<unique_ptr<Order>>, greater<double>>& get_asks() { return m_asks; }
